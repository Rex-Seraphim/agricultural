				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="联系电话" prop="contactPhone">
							<el-input class="list_inp" v-model="form.contactPhone" placeholder="联系电话"
								 type="text" 								:readonly="!isAdd||disabledForm.contactPhone?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='contactPhone'){
					form.value.contactPhone = row[x];
					disabledForm.value.contactPhone = true;
					continue;
				}
				if(x=='address'){
